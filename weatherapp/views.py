            ...
            if geocode_data['results']:
                ...
                if weather_response.status_code == 200:
                    ...
                    if poi_response.status_code == 200:
                        ...
                        for poi in poi_list:
                            poi_id = poi['fsq_id']  # Get the unique ID of the POI
                            ...
                            if image_response.status_code == 200:
                                ...
                                if image_data:
                                    ...
                                    image = image_data[0]
                                    # Construct image URL using prefix, suffix, and size
                                    poi['image_url'] = f"{image['prefix']}original{image['suffix']}"
                                else:
                                    poi['image_url'] = None  # No image available
                            else:
                                poi['image_url'] = None  # Error fetching image
